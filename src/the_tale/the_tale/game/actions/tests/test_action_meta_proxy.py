...
class MetaProxyActionForArenaPvP1x1Tests(utils_testcase.TestCase, pvp_tests_helpers.PvPTestsMixin):
    ...
    def setUp(self):
        ...
        self.pvp_create_battle(self.account_1, self.account_2, pvp_models.BATTLE_1X1_STATE.PROCESSING)
        self.pvp_create_battle(self.account_2, self.account_1, pvp_models.BATTLE_1X1_STATE.PROCESSING)
