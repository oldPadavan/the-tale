...
class MobRecord(django_models.Model):
    ...
    type = rels_django.RelationIntegerField(relation=beings_relations.TYPE, db_index=True)
    ...
    communication_verbal = rels_django.RelationIntegerField(relation=beings_relations.COMMUNICATION_VERBAL, db_index=True)
    communication_gestures = rels_django.RelationIntegerField(relation=beings_relations.COMMUNICATION_GESTURES, db_index=True)
    communication_telepathic = rels_django.RelationIntegerField(relation=beings_relations.COMMUNICATION_TELEPATHIC, db_index=True)

    intellect_level = rels_django.RelationIntegerField(relation=beings_relations.INTELLECT_LEVEL, db_index=True)
