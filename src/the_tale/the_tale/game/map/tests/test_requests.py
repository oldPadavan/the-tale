...
class CellInfoTests(RequestsTestsBase):
    ...
    def test_outside_map(self):
        ...
        self.check_html_ok(self.request_html(dext_urls.url('game:map:cell-info', x=conf.map_settings.WIDTH-1, y=conf.map_settings.HEIGHT-1)), texts=[('outside_map', 0)])
        ...
        self.check_html_ok(self.request_html(dext_urls.url('game:map:cell-info', x=conf.map_settings.WIDTH, y=conf.map_settings.HEIGHT-1)), texts=[('outside_map', 1)])
        self.check_html_ok(self.request_html(dext_urls.url('game:map:cell-info', x=conf.map_settings.WIDTH-1, y=conf.map_settings.HEIGHT)), texts=[('outside_map', 1)])
