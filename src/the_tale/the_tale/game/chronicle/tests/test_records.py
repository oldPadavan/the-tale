...
class RecordTests(utils_testcase.TestCase):
    ...
    def setUp(self):
        ...
        bill_data = bills_bills.place_renaming.PlaceRenaming(place_id=self.place_1.id, name_forms=names.generator().get_test_name('new_name'))
    ...
    def create_bill_decline__exchange(self):
        resource_1, resource_2 = bills_tests_helpers.choose_exchange_resources()
    ...
    def create_bill_decline__conversion(self):
        conversion_1, conversion_2 = bills_tests_helpers.choose_conversions()
