...
class GetApplicableBillsTest(helpers.BaseTestPrototypes):
    ...
    def setUp(self):
        ...
        prototypes.BillPrototype._model_class.objects.all().update(updated_at=datetime.datetime.now() - datetime.timedelta(seconds=conf.bills_settings.BILL_LIVE_TIME),
...
class TestActorPrototype(helpers.BaseTestPrototypes):
    ...
    def setUp(self):
        ...
        self.bill_data = bills.place_renaming.PlaceRenaming(place_id=self.place1.id, name_forms=names.generator().get_test_name('new_name_1'))
    ...
    def test_actors_after_user_update(self):
        ...
        data = linguistics_tests_helpers.get_word_post_data(noun, prefix='name')
